...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BNRItemViewController *ivc = (BNRItemViewController*)[sb instantiateViewControllerWithIdentifier:@"itemView"];
    [ivc.view setBackgroundColor:[UIColor cyanColor]];
    
    UINavigationController *navController = [[UINavigationController alloc]initWithRootViewController:ivc];
    [self.window setRootViewController:navController];
    //navController.navigationBar.hidden = 2;
